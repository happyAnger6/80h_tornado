...
application = tornado.web.Application([
	...
	(r"^/main1", "controller.main.HomeHandler"),
	(r"^/(page/(\d+))?", "controller.main.HomeHandler"),
	(r"^/forum", "controller.forum.ForumHandler"),
	(r"^/ZhxpTest", "controller.zhangxp.ZhxpTestHandler"),
	(r"^/login", "controller.auth.LoginHandler"),
	(r"^/register", "controller.auth.RegisterHandler"),
	(r"^/test1", "controller.test1.Test1Handler"),
	(r"^/playgame", "controller.play.PlayGameHandler"),
	(r"^/playgame/([a-z]+)(/(.*))?", "controller.play.PlayGameHandler"),
	...
	(r"^/class/([a-z]+)(/(.*))?", "controller.class.ClassHandler"),
	...
	(r"^/jquery", "controller.jquery.JqueryHandler"),
